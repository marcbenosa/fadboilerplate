 ...
 */
function fadboilerplate_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'fadboilerplate' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'fadboilerplate' ),
...
add_action( 'widgets_init', 'fadboilerplate_widgets_init' );
